...
namespace Practt27
{
    ...
    {
        IWebDriver driver;
        private string TestData_Email ="korisnik@12334567.comm";
        private string TestData_Password = "MnogoJakaSifra1";
        ...
        {
            IWebElement sigIn = driver.FindElement(By.LinkText("Sign in"));
